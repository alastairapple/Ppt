  ...
  <div class="writing-board-tool">
    ...
    >
      <div class="tools" @mousedown.stop>
        ...
        <div class="btn close" v-tooltip="'Close writing board'" @click="closeWritingBoard()">
...
// When opening the writing board or switching pages, draw the ink stored in the database onto the canvas
watch(currentSlide, () => {
...
// Save the drawing to the database after each drawing is completed
