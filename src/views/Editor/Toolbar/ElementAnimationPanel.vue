            ...
            <div class="config-item">
              ...
              <Select
                ...
                :options="[
                  ...
                  { label: 'Simultaneously with previous', value: 'meantime' },
...
// Synchronize data after dragging to change animation order
...
// Update element animation and execute a preview
...
// Add element animation and execute a preview
...
// Remove the mask layer 600ms after the animation selection panel opens, otherwise, quickly sliding the mouse to preview will cause jitter.
