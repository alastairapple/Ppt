    ...
    <div class="configs">
      ...
      <div class="row">
        ...
        <div class="config-item">
          <Switch v-model:value="ignoreMedia" v-tooltip="'By default, audio/video is ignored during export. If your slides contain audio or video elements and you wish to export them to the PPTX file, you can disable the [Ignore Audio/Video] option. However, be aware that this will significantly increase the export time.'" />
        </div>
      </div>
      <div class="row">
      ...
      <div class="tip" v-if="!ignoreMedia">
        Tips: 1. Supported export formats: avi, mp4, mov, wmv, mp3, wav; 2. Cross-origin resources cannot be exported.
      </div>
    </div>
    <div class="btns">
