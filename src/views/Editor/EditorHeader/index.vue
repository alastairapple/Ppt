  ...
  <div class="editor-header">
    <div class="left">
      <Popover trigger="click" placement="bottom-start" v-model:value="mainMenuVisible">
        <template #content>
          <PopoverMenuItem @click="openAIPPTDialog(); mainMenuVisible = false">AI Generate PPT</PopoverMenuItem>
          <FileInput accept="application/vnd.openxmlformats-officedocument.presentationml.presentation"  @change="files => {
            importPPTXFile(files)
            mainMenuVisible = false
          }">
            <PopoverMenuItem>Import PPTX File (Test)</PopoverMenuItem>
          </FileInput>
          <FileInput accept=".json"  @change="files => {
            importJSON(files)
            mainMenuVisible = false
          }">
            <PopoverMenuItem>Import JSON File (Test)</PopoverMenuItem>
          </FileInput>
          ...
          <PopoverMenuItem @click="openMarkupPanel(); mainMenuVisible = false">Slide Type Annotation</PopoverMenuItem>
          <PopoverMenuItem @click="goLink('https://github.com/pipipi-pikachu/PPTist/issues')">Feedback</PopoverMenuItem>
          <PopoverMenuItem @click="goLink('https://github.com/pipipi-pikachu/PPTist/blob/master/doc/Q&A.md')">FAQ</PopoverMenuItem>
    ...
    <div class="right">
      <div class="group-menu-item">
        ...
        <Popover trigger="click" center>
          <template #content>
            <PopoverMenuItem @click="enterScreeningFromStart()">Start from Beginning</PopoverMenuItem>
            <PopoverMenuItem @click="enterScreening()">Start from Current Slide</PopoverMenuItem>
          </template>
