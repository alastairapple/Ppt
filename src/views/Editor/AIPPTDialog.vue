<template>
  <div class="aippt-dialog">
    <div class="header">
      ...
      <span class="subtite" v-if="step === 'template'">Select a template from below to start generating your PPT</span>
      <span class="subtite" v-else-if="step === 'outline'">Confirm the content outline below (click to edit content, right-click to add/delete outline items), then start selecting a template</span>
      <span class="subtite" v-else>Enter your PPT topic below and provide additional information such as industry, job role, subject, purpose, etc.</span>
    </div>
    ...
    <template v-if="step === 'setup'">
      <Input class="input" 
        ...
        :maxlength="50" 
        placeholder="Enter PPT topic, e.g., University Student Career Planning" 
        @enter="createOutline()"
      >
        <template #suffix>
...
const recommends = ref([
  'Company Annual Meeting Planning Proposal',
  'How Big Data is Changing the World',
  'Catering Market Research and Analysis',
  'Application of AIGC in Education',
  'How 5G Technology is Changing Our Lives',
...
const createOutline = async () => {
  if (!keyword.value) return message.error('Please enter the PPT topic first')
