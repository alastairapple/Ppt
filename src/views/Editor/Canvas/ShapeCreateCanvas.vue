...
onMounted(() => {
  message.success('Click to draw any shape, close the shape by connecting the start and end points, press ESC or right-click to cancel, press ENTER to finish early', {
    duration: 0,
  })
