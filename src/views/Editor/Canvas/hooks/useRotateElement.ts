...
/**
 * Calculates the radian of the line connecting the given coordinates to the origin.
...
export default (
  ...
  const rotateElement = (e: MouseEvent | TouchEvent, element: Exclude<PPTElement, PPTChartElement | PPTLineElement | PPTVideoElement | PPTAudioElement>) => {
    ...
    // Element's center point (rotation center point)
    ...
    const handleMousemove = (e: MouseEvent | TouchEvent) => {
      ...
      // Calculate the angle (in radians) of the line connecting the current mouse position to the element's center
      ...
      // Snapping effect to angles that are multiples of 45 degrees
