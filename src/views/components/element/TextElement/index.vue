  ...
  >
    ...
    >
      ...
      >
        ...
        <!-- When the font size is too large and the line height is too small, the text will overflow, making the drag area unselectable. Therefore, the following nodes are added to prevent this situation. -->
...
// Monitor the size changes of the text element. When the height changes, update the height to Vuex.
// If the height change occurs during a scaling operation, wait until the scaling operation is completed before updating.
