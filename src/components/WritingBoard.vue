...
// Whether the mouse is within the canvas area: only display pen or eraser if within the area
const mouseInCanvas = ref(false)

// Listen to update canvas size
...
// When switching pen modes, update canvas ctx configuration
const updateCtx = () => {
  if (!ctx) return
  if (props.model === 'mark') {
...
// Calculate drawing speed based on distance s and time t between two mouse movements. The faster the speed, the thinner the ink.
...
// Start drawing/erasing ink (moving)
