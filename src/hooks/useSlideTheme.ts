...
export default () => {
  ...
  // Get the main theme styles within a specified slide, sorted by their proportion
  ...
  // Get the main colors within a specified slide (ignoring transparency), sorted by color area
  ...
  // Create a mapping table from original colors to new colors
