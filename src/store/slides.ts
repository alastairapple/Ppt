...
export const useSlidesStore = defineStore('slides', {
  ...
  getters: {
    ...
    // Merge items with trigger "simultaneous with previous animation" upwards to the same position in the sequence
    // Add auto-down execution mark to the previous item of items with trigger "after previous animation"
