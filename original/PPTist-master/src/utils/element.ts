...
/**
 * Calculate the new position range of an element in the canvas after rotation.
...
/**
 * Calculate the offset distance of an element's new position after rotation compared to its original position.
 * @param element The element's position, size, and rotation angle information.
 */
...
/**
 * Deduplicate a set of alignment guide lines: for guide lines at the same position, keep only one, merging their ranges.
 * @param lines A set of alignment guide line information.
 */
...
/**
 * Based on a list of slides, generate a new ID for each slide and create a map associating new IDs with old IDs.
 * This is mainly used for elements within a slide, to maintain the relationships of existing slide IDs in the data.
...
/**
   * Based on a list of elements, generate a new ID for each element and create a map associating new IDs with old IDs.
   * This is mainly used when copying elements, to maintain the relationships of existing element IDs in the data.
   * For example, two grouped elements that originally had the same groupId will still have the same groupId after copying.
   * @param elements A list of element data.
   */
...
/**
 * Get sub-colors for color matching based on the main theme color of a table.
