...
export const readClipboard = (): Promise<string> => {
  return new Promise((resolve, reject) => {
    ...
    else reject('Browser does not support or prohibit access to the clipboard, please use shortcut Ctrl + V')
  })
}
...
// Attempt to parse clipboard content as HTML table code
