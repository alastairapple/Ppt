...
export default (viewportRef: ShallowRef<HTMLElement | null>) => {
  ...
  // By the start and end points of mouse selection, calculate the position and size of the selection area
  ...
  // By the start and end points of mouse selection, calculate the position and start/end points of the line in the canvas
