...
export default (elementList: Ref<PPTElement[]>) => {
  ...
  const dragLineElement = (e: MouseEvent, element: PPTLineElement, command: OperateLineHandlers) => {
    ...
    // Get the 8 scaling points of all non-rotated elements (excluding lines) as adsorption positions
    ...
    document.onmousemove = e => {
      ...
      // Position of the line's start and end points in the editing area
      ...
      // Position of dragging start or end point
      ...
      // Calculate the coordinates of the updated start and end points based on their own element positions
