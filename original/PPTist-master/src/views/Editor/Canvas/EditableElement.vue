...
const currentElementComponent = computed<unknown>(() => {
  ...
  return element_Type_Map[props.elementInfo.type] || null
})
...
const contextmenus = (): ContextmenuItem[] => {
  ...
  return [
    ...
    { divider: true },
    {
      ...
      children: [
        { text: 'Center Both Horizontally and Vertically', handler: () => alignElementToCanvas(ElementAlignCommands.CENTER), },
    ...
    {
      text: props.elementInfo.groupId ? 'Uncombine' : 'Combine',
      subText: 'Ctrl + G',
