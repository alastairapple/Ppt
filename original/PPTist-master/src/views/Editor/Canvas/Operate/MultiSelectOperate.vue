...
// Based on the overall range of multiple selected elements on the canvas, calculate the position information of border lines and scaling points
...
// Calculate the overall range of multiple selected elements on the canvas
const setRange = () => {
