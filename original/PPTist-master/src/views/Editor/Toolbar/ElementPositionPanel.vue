<template>
  <div class="element-positopn-panel">
    ...
    <ButtonGroup class="row">
      <Button style="flex: 1;" @click="orderElement(handleElement!, ElementOrderCommands.UP)"><IconBringToFront class="btn-icon" /> Bring Forward</Button>
      <Button style="flex: 1;" @click="orderElement(handleElement!, ElementOrderCommands.DOWN)"><IconSentToBack class="btn-icon" /> Send Backward</Button>
    </ButtonGroup>
    ...
    <ButtonGroup class="row">
      <Button style="flex: 1;" v-tooltip="'Left Align'" @click="alignElementToCanvas(ElementAlignCommands.LEFT)"><IconAlignLeft /></Button>
    ...
    <ButtonGroup class="row">
      <Button style="flex: 1;" v-tooltip="'Top Align'" @click="alignElementToCanvas(ElementAlignCommands.TOP)"><IconAlignTop /></Button>
...
// When setting width and height for shapes, it's necessary to check if the shape path needs to be updated
