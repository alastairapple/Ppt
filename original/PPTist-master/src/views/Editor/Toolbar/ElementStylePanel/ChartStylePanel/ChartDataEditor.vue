...
// Initialize chart data: format and populate data into DOM
const initData = () => {
...
// Hotkey listener: Enter moves focus to the next row
const moveNextRow = () => {
...
// Get current chart DOM data, format it, and pass it up
const getTableData = () => {
  ...
  // The first row contains series names, the first column contains item names. Actual data starts from the second row, second column.
  ...
  // Scatter plots have exactly two columns of data
  ...
  // Pie charts and ring charts only have one column of data
...
// Mouse drag to change selected data range
const changeSelectRange = (e: MouseEvent) => {
  ...
  document.onmouseup = e => {
    ...
    // When dragging ends, if the range exceeds half of a cell, it automatically expands to the next cell (e.g., dragging to over one and a half cells automatically expands to two cells, horizontally and vertically).
