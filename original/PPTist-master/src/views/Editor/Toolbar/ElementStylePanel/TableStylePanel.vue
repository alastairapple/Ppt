<template>
  <div class="table-style-panel">
    ...
    >
      ...
      <RadioButton value="center" v-tooltip="'Center align'" style="flex: 1;"><IconAlignTextCenter /></RadioButton>
      <RadioButton value="right" v-tooltip="'Right align'" style="flex: 1;"><IconAlignTextRight /></RadioButton>
      <RadioButton value="justify" v-tooltip="'Justify align'" style="flex: 1;"><IconAlignTextBoth /></RadioButton>
    </RadioGroup>
...
// Update active cell's text style status
