<template>
  <div class="multi-style-panel">
    ...
    >
      ...
      <RadioButton value="center" style="flex: 1;" v-tooltip="'Align Center'"><IconAlignTextCenter /></RadioButton>
      <RadioButton value="right" style="flex: 1;" v-tooltip="'Align Right'"><IconAlignTextRight /></RadioButton>
      <RadioButton value="justify" style="flex: 1;" v-tooltip="'Align Justify'"><IconAlignTextBoth /></RadioButton>
    </RadioGroup>
  </div>
</template>
...
// Batch modify fill color (for table cell fill and audio icon color)
