<template>
  <div class="theme-styles-extract">
    ...
    <div class="btns">
      <Button class="btn" type="primary" @click="updateAllThemes()">Save selected configurations as a theme</Button>
    </div>
  </div>
</template>
...
const updateAllThemes = () => {
  ...
  if (themeColors.length > 6) {
    ...
    message.warning('Theme color exceeds the quantity limit. The first 6 have been automatically selected.')
  }
