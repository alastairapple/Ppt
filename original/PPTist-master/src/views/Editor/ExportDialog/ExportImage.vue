<template>
  <div class="export-img-dialog">
    ...
    <div class="configs">
      ...
      <div class="row">
        <div class="title">Ignore Webfont:</div>
        <div class="config-item">
          <Switch v-model:value="ignoreWebfont" v-tooltip="'By default, online fonts are ignored during export. If you have used online fonts in your slides and wish to retain their styles after export, you can choose to disable the [Ignore Webfont] option. However, please note that this will increase the export time.'" />
        </div>
      </div>
    </div>
