...
// Get clip area information (the proportion of the clip area to the original image, and its position within the original image)
...
// Bottom image position and size (image in the masked area)
...
// Bottom image position and size style (image in the masked area)
...
// Top image container position and size (clipped highlighted area)
...
// Top image container position and size style (clipped highlighted area)
...
// Top image position and size style (image in the clipped area)
...
// Initialize clip position information
...
// Execute clipping: calculate the position and size of the clipped image and synchronize the data
const handleClip = () => {
...
// Keyboard listener: Enter to confirm clipping
