...
// Listen to various rich text interaction events:
// Cancel global hotkey events on focus
// Synchronize data to Vuex when typing
// Synchronize rich text state to the toolbar on click and keyboard input
const handleInput = debounce(function(isHandleHistory = false) {
...
const handleFocus = () => {
  // Do not disable global hotkeys if multiple items are selected and ctrl or shift key is pressed
...
// Open/close editor editing mode
...
// For partial commands, check if the current selection is empty first. If empty, perform a select all operation.
  ...
  for (const item of actions) {
    if (item.command === 'fontname' && item.value !== undefined) {
      ...
      if (item.value && !document.fonts.check(`16px ${item.value}`)) {
        message.warning('Font needs to wait for loading and downloading before it takes effect, please wait a moment')
      }
    }
...
// When mouse is up, execute format painter command
const handleMouseup = () => {
...
// Prosemirror editor initialization and unmount
onMounted(() => {
...
.prosemirror-editor {
  ...
  &.format-painter {
    cursor: url(data:image/svg+xml;base64,#14.179,16.388) 2 5, default !important;
  }
}
</style>
