...
// Update the editable state of the table. When the table is in edit state, global shortcuts need to be disabled.
...
// Monitor the size changes of table elements. When the height changes, update the height to Vuex.
// If a scaling operation is in progress when the height changes, wait for the scaling operation to complete before updating.
...
// Update the currently selected table cells
