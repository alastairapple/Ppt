  ...
  <div class="base-view" :class="{ 'laser-pen': laserPen }">
    ...
    >
      <div class="content">
        ...
        <IconMagic class="tool-btn" v-tooltip="'Laser Pen'" :class="{ 'active': laserPen }" @click="laserPen = !laserPen" />
