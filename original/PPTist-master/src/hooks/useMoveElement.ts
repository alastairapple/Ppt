...
export default () => {
  ...
  /**
   * Move elements in a specified direction by a specified distance
   * If there are selected elements within a group that can be operated independently,
   * prioritize moving that element. Otherwise, move all selected elements by default.
